# Projeto StarWars Planets DataTable
...
- Implementa a lógica de páginação para melhor visualização dessa quantidade de dados.
- Implementa lógica para filtragem e busca de dados em todas as páginas.
